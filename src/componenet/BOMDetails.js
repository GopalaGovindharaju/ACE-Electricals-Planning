            ...
            <div class="col-md-18">
                ...
                <div class="row second-div">
                    ...
                    <div class="col">
                        ...
                        <center>
                        <div class="row-md">
                            <button class="btn btn-primary rounded text-white border border-transparent">Submit Allocation</button>
                        </div>
                        </center>
                        <br></br>
                        <center>
                        <div class="row-md">
                            <button class="btn btn-primary rounded text-white border border-transparent">Edit Allocation</button>
                        </div>
                        </center>
                        <br></br>
                    </div>
